...
#         yaml_file = '/home/pinky/calib/ost.yaml'  # 수정 필요
#         if not os.path.exists(yaml_file):
#             self.get_logger().warn(f"YAML file {yaml_file} not found, skipping camera info loading.")
#             return None
...
#                 camera_info.k = data['camera_matrix']['data']  # 1차원 리스트로 설정
